    ...
    public void importData(List<DanmuRecord> danmuRecords, List<UserRecord> userRecords, List<VideoRecord> videoRecords) {

        {
            ...
            String sql_disable_trigger = """
                    ALTER TABLE UserRecord DISABLE TRIGGER userrecord_after_insert;
                    ALTER TABLE UserRecord DISABLE TRIGGER userrecord_after_update;
                    ALTER TABLE UserRecord DISABLE TRIGGER userrecord_after_delete;
                    ALTER TABLE DanmuRecord DISABLE TRIGGER dirty_words;
                    ALTER TABLE Likes DISABLE TRIGGER trigger_likes_after_change;
                    ALTER TABLE Favorites DISABLE TRIGGER trigger_favorites_after_change;
                    ALTER TABLE VideoRecord DISABLE TRIGGER trigger_videorecord_after_change;
                    """;
            String sql_enable_trigger = """
                                        ALTER TABLE UserRecord ENABLE TRIGGER userrecord_after_insert;
                    ALTER TABLE UserRecord ENABLE TRIGGER userrecord_after_update;
                    ALTER TABLE UserRecord ENABLE TRIGGER userrecord_after_delete;
                    ALTER TABLE DanmuRecord ENABLE TRIGGER dirty_words;
                    ALTER TABLE Likes ENABLE TRIGGER trigger_likes_after_change;
                    ALTER TABLE Favorites ENABLE TRIGGER trigger_favorites_after_change;
                    ALTER TABLE VideoRecord ENABLE TRIGGER trigger_videorecord_after_change;""";
